...
/* 	Copyright © 2012  Red Pixel Studios  (email : support@redpixel.com)
...
class RPS_Blog_Info {
	...
	public function rps_blog_info() {
		...
		if ( is_multisite() ) :
			...
			$blog_public = ( $blog_info->public == 1 ) ? 'No Index' : 'Index';
		...
		if ( is_singular() || ( is_admin() && ( isset( $pagenow ) && $pagenow == 'post.php' || isset( $pagenow ) && $pagenow == 'media.php' ) ) ) :
			$post_type = strtoupper( str_ireplace('_', ' ', $post->post_type ) );
